...
-- 6) What are the top 3 sectors with the fewest opportunities won? Compare with the top 3 sectors with more opportunities won how far those sectors are from the average per type of deal and adding a rank:
