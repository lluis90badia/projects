...
Once the tables were loaded, relationships through key columns were built using **1:N cardinality**, resulting in a **snowflake schema** for better normalisation.
...
### 3. [Visualisation](https://github.com/lluis90badia/projects/blob/main/data_analyst_projects/adventure_works_cycles_powerbi/aw_report.pbix) & Analysis
