...
Esta es la información que se ha recopilado para cada entidad ([archivos CSV](https://github.com/lluis90badia/projects/blob/main/projects/proyecto_SQL_concesionario/archivos_csv/archivos_csv)):
